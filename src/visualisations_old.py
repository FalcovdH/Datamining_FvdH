...
def category_weekday_polar_plot(df):
    ...
    weekday_grouped_msg = (
        df.groupby(["year", "weekday"])["message"]
        .value_counts()
...
def time_wins_mentions(df, interval="year"):
    ...
    plt.savefig(
        r"C:/Users/a427617/Documents/Master Data science/Blok 3 - Data mining/Data-Mining---2024/img/time_Gewonnen_verloren.png"
    )
    plt.show()
...
def distributie_plot_message_length(df):
    ...
    g_day = sns.FacetGrid(
        df_filtered, col="day_of_week", col_wrap=4, height=3, col_order=days_order
    )
    g_day.map(
    ...
    g_quarter = sns.FacetGrid(
        df_filtered, col="quarter", col_wrap=4, height=3, col_order=quarters_order
    )
    g_quarter.map(
    ...
    g_day.savefig(
        save_location + "distributie_message_length_per_day_of_week.png"
    )  # Save the plot
    g_quarter.savefig(
        save_location + "distributie_message_length_per_quarter.png"
    )  # Save the plot
    g_year.savefig(
        save_location + "distributie_message_length_per_year.png"
    )  # Save the plot
    # Show the plots
    plt.show()
...
def relations_mean_message_vs_media(df):
    ...
    df["has_media"] = df["message"].str.contains(
    ...
    ax = sns.scatterplot(
        ...
        alpha=0.3,
        hue="author_category",
        palette={"Teamlead": "red", "Teammember": "blue", "Ex-teammember": "gray"},
    )

    # Add title and subtitle with smaller font size
    plt.title(
        "Comparison of Teamlead (red), teammembers (blue) and ex-teammembers (gray)",
        fontsize=9,
    )
    ...
    plt.savefig(
        r"C:/Users/a427617/Documents/Master Data science/Blok 3 - Data mining/Data-Mining---2024/img/relation_message_media.png"
    )
    plt.show()


processed = Path(
    r"C:/Users/a427617/Documents/Master Data science/Blok 3 - Data mining/Data-Mining---2024/data/processed"
)
print(processed)
...
time_bbq_mentions(
    df,
    save_path=r"C:/Users/a427617/Documents/Master Data science/Blok 3 - Data mining/Data-Mining---2024/img/time_bbq_vermeldingen.png",
)
